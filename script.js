...
const tokenPatterns = [
  ...
  ["tok-keyword", /^(func|struct|enum|variant|table|if|elif|else|while|for|in|end|return|of|this|break|continue|use|as|true|false|and|or|not|extern|init|hints|must|try|except|throws|foreign|is|match|case|other)\b/],
